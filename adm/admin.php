...
<input class="btn btn-xs btn-success" type="submit" name="submit" value="create" style="float: right; margin-right: 90px;"> <br>	
</form>
...
?>
	<tr align="center">
		...
		<a href="del_adm.php?id_wis=<?php echo $rec['id_wis'] ?>" class="btn btn-xs btn-danger" onClick="return confirm('Apakah anda yakin akan menghapus data ini?')">Delete</a></td>
	</tr>
	<tr align="center">
		<td>Koordinat</td>
